...
<head>
  <meta charset="utf-8">
	...
	<link rel="stylesheet" href="css/playlistSurprise.css">
  ...
  <!-- 감정 메뉴 버튼 리스트-->
    <ul id="emotionmenu">
      <!--각 버튼 클릭시 해당 감정 플리로 이동-->
        ...
        <li><button name="surprise" type="button" class="surprise">놀람</button></li>
        <li><button name="angry" type="button" class="emotionbutton" onclick="location.href='playlistAngry.php'">화남</button></li>
    </ul>
    <!--편집버튼, 나가기 버튼(X)-->
        <button id="edit" type="button" name="edit" onClick="location.href='playlistSurpriseEdit.php'">편집</button>
