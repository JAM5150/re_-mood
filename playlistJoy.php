...
<head>
  <meta charset="utf-8">
	...
	<link rel="stylesheet" href="css/playlistJoy.css">
...
<div class="outside">
  <!-- 감정 메뉴 버튼 리스트-->
    <ul id="emotionmenu">
        ...
        <li><button name="joy" type="button" class="joy">기쁨</button></li>
    ...
    <!--편집버튼, 나가기 버튼(X)-->
        <button id="edit" type="button" name="edit" onClick="location.href='playlistJoyEdit.php'">편집</button>
