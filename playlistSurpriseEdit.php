...
<head>
  <meta charset="utf-8">
	...
	<link rel="stylesheet" href="css/playlistSurpriseEdit.css">
...
<div class="outside">
    <ul id="emotionmenu">
          ...
          <li><button name="sad" type="button" class="emotionbutton">슬픔</button></li>
  ...
  <script type="text/JavaScript" src="js/playlistSurpriseEdit.js"></script> 
  </body>
  </html>      