...
for($j = 0; $j < $playlist_length; $j = $j + 1) {
	...
	echo "<br/>artist_name: ".$return_artist_name[$j]." track_name: ".$return_track_name[$j]." track_image: ".$return_track_image[$j]." track_prev: ".$return_track_prev[$j]." track_id: ".$return_track_id[$j];
}
