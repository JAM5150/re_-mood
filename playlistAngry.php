...
<head>
  <meta charset="utf-8">
	...
	<link rel="stylesheet" href="css/playlistAngry.css">
...
<div class="outside">
  <!-- 감정 메뉴 버튼 리스트-->
    <ul id="emotionmenu">
        ...
        <li><button name="soso" type="button" class="emotionbutton" onclick="location.href='playlistSoso.php'">보통</button></li>
        <li><button name="surprise" type="button" class="emotionbutton" onclick="location.href='playlistSurprise.php'">놀람</button></li>
        <li><button name="angry" type="button" class="angry">화남</button></li>
    </ul>
    <!--편집버튼, 나가기 버튼(X)-->
        <button id="edit" type="button" name="edit" onClick="location.href='playlistAngryEdit.php'">편집</button>
